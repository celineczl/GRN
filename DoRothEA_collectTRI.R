...
# matrix # 219 rows
TF_net_DORO_cdkn1a <- subset(net_DORO, source == TF_DORO_cdkn1a & confidence %in% c("A", "B", "C"))
...
# Use split() to create a list of targets for each TF
TF_list_DORO_cdkn1a <- split(TF_matrix_DORO_cdkn1a[, 3], TF_matrix_DORO_cdkn1a[, 1])
